...
void rtcSetup(){
  if(bootCount==0){
    rtc.setTime(0, 0, 23, 10, 11, 2023);  // 17th Jan 2021 15:24:30
  }
  else{
    secondRTC = secondRTC+TIME_TO_SLEEP;
    rtc.setTime(secondRTC, minuteRTC, hourRTC, dayRTC, monthRTC, yearRTC);  // 17th Jan 2021 15:24:30 
  }  
  // Serial.println("\n\n#################################################");
